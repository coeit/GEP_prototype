import React, { useState, useLayoutEffect } from '../../web_modules/react.js';
/**
...
const useDebouncedRippleCleanUp = (rippleCount, duration, cleanUpFunction) => useLayoutEffect(() => {
  let bounce = null;
...
export default function Ripple({
  ...
  const addRipple = event => {
    ...
    const size = rippleContainer.width > rippleContainer.height ? rippleContainer.width : rippleContainer.height; // Create the ripple at the mouse-event origin coordinates
  ...
  }, rippleArray.map((ripple, index) => /*#__PURE__*/React.createElement("span", {
